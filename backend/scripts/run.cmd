...
venv\Scripts\uvicorn src.server:app --reload --host="gunkonk.ru" --port=8443 --workers=4 --ssl-keyfile="cert\\privkey.pem" --ssl-certfile="cert\\cert.pem" --ssl-ca-certs "cert\\fullchain.pem" --log-level="info"
rem venv\Scripts\uvicorn src.server:app --reload --host="127.0.0.1" --port=8443 --workers=4
--ssl-keyfile="cert\\privkey.pem"
--ssl-certfile="cert\\cert.pem"
--ssl-ca-certs "cert\\fullchain.pem" --log-level="info"