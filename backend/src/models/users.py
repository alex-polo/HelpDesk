...
class User(SQLAlchemyBaseUserTable[int], Base):
    ...
    email: Mapped[int] = mapped_column(String(50), nullable=True, unique=False)
    ...
    is_verified: Mapped[bool] = mapped_column(Boolean, nullable=False, unique=False, default=True)
